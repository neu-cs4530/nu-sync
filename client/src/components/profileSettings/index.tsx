          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
                  ...
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div className="sm:col-span-1">
                      ...
                      <div className="mt-1 text-sm text-gray-900 flex items-center">
                        ...
                        <div className="ml-1" />
                        <UserStatusIcon
                          status={userData.onlineStatus?.status ?? 'online'}
                        />
                      </div>
                    </div>
                    <div className="sm:col-span-1">
              ...
              {canEditProfile && (
                <div className="profile-settings-section">
                  ...
                  <p className="setting-description">
                    Automatically sets your status to DND and silences
                    notifications.
                  </p>
                  <button
              ...
              {canEditProfile && userData?.quietHours && (
                ...
                >
                  Current Quiet Hours: {userData.quietHours.start} –{' '}
                  {userData.quietHours.end}
                </p>
              )}
                ...
                <div className="quiet-hours-modal">
                  <div className="modal-content quiet-hours-modal-content">
                    ...
                    <p className="modal-info">
                      This will schedule you to block notifications within this
                      time frame.
                    </p>
                  ...
                  <div className="bg-gray-50 p-4 rounded-md flex items-center justify-between">
                    <div>
                      {spotifyCompatibilityScore !== undefined ? (
                        <>
                          <p className="text-sm font-medium text-gray-700">
                            Your music taste compatibility with{' '}
                        ...
                        <p className="text-sm text-gray-500 italic">
                          Compatibility unavailable. Either you or{' '}
                          {userData?.username} hasn&rsquo;t connected to
                          Spotify.
                        </p>
                      )}
                    </div>
